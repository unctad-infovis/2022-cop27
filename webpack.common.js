  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: 'assets/data/data - figure1.csv', to: '../public/assets/data/2022-cop27_figure_1.csv', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
        { from: 'assets/data/data - figure2.csv', to: '../public/assets/data/2022-cop27_figure_2.csv', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
